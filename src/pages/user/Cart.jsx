...
const Cart = () => {
  ...
  return (
    <div className="pb-32 pt-4"> {/* Extra padding for bottom nav and checkout button */}
      <h1 className="text-xl font-bold px-4 mb-4">Shopping Cart</h1>
      ...
      {cartItems.length === 0 && (
        <div className="flex flex-col items-center justify-center h-[60vh]">
          <div className="w-16 h-16 bg-gray-100 rounded-full mb-4 flex items-center justify-center">
            <HiTrash className="w-8 h-8 text-gray-400" />
          </div>
